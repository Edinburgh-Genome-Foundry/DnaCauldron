...
class FragmentChain:
    ...
    def reverse_complement(self):
        ...
        """
        return FragmentChain([f.reverse_fragment
    ...
    def standardized(self):
        ...
        if self.is_standardized:
            ...
            return FragmentChain(self.fragments, self.is_standardized,
                                  is_cycle=self.is_cycle,
        ...
        if len(backbones) == 1:
            ...
            if backbone.is_reversed:
                ...
                return FragmentChain(self.fragments,
                ...
                return FragmentChain(std_fragments,
                                      is_standardized=True,
                                      is_cycle=self.is_cycle)
        ...
        return FragmentChain(std_fragments, is_standardized=True,
                              is_cycle=self.is_cycle)
